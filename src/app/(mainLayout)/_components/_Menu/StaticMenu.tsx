  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className={cn(
          "flex max-w-fits w-[1400px] fixed top-10 inset-x-0 mx-auto  z-[5000]   items-center justify-center",
          className
        )}
        initial={{
          opacity: 1,
      ...
      >
        <div className="w-full flex justify-between items-center">
          <h2 className="text-4xl uppercase dark:bg-black bg-white  shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] p-3 border border-transparent dark:border-white/[0.2] rounded-md">
            Ali Ashraf
          </h2>
