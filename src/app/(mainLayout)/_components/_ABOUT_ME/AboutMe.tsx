  ...
  return (
    <Container>
      <div className="flex flex-col-reverse lg:flex-row-reverse gap-5 items-center justify-between lg:px-0 px-5 w-full ">
        <div className="lg:w-1/2  w-full flex lg:items-center flex-col justify-center">
          <h1 className="text-4xl  md:text-4xl lg:text-6xl font-semibold max-w-7xl lg:mx-auto text- mt-6 relative z-20 py-6 bg-clip-text text-transparent bg-gradient-to-b from-neutral-800 via-neutral-700 to-neutral-700 dark:from-neutral-800 dark:via-white dark:to-white">
